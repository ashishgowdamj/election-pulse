...
interface MiniCasteChartProps {
  data: CasteData[];
  onRefresh?: () => Promise<void> | void;
}

const MiniCasteChart = ({ data, onRefresh }: MiniCasteChartProps) => {
  ...
  return (
    <section className="bg-card border border-border rounded-2xl p-5 shadow-sm h-full">
      <div className="flex items-center justify-between mb-4 gap-3">
        <div>
          <h3 className="text-xl font-semibold text-foreground">Caste</h3>
        </div>
